...
public final class DialogUnit {
    ...
    public final static int mapUnitX(final int unitX) {
        return unitX * baseUnitX / 4;
    }

    public final static int mapUnitY(final int unitY) {
        return unitY * baseUnitY / 8;
    }

    public final static int mapUnitYWithCorrection(final int unitY) {
        return unitY * baseUnitY / 8 - CORRECTION;
    }

    public final static Rectangle mapUnits(final Rectangle r) {
        final Rectangle rect = new Rectangle(DialogUnit.mapUnitX(r.x),
    ...
    public final static Rectangle mapUnitsWithoutCorrection(final Rectangle r) {
        final Rectangle rect = new Rectangle(DialogUnit.mapUnitX(r.x),
