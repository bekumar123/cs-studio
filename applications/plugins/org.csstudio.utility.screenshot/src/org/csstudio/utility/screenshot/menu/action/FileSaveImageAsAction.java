...
public class FileSaveImageAsAction extends Action {
    ...
    public FileSaveImageAsAction(final ScreenshotWorker w) {
        worker = w;
    ...
    public void run() {
        ...
        final FileDialog dialog = new FileDialog(worker.getDisplay().getActiveShell(), SWT.SAVE);
        ...
        if(result != null) {
            ...
            if(indexOfDot != -1) {
                ...
                final String e = result.substring(indexOfDot + 1).toLowerCase();
