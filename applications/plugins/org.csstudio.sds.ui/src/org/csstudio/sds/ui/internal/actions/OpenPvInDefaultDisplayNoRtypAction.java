 ...
 */
public class OpenPvInDefaultDisplayNoRtypAction extends AbstractHandler {

	private static final Logger LOG = LoggerFactory
			.getLogger(OpenPvInDefaultDisplayNoRtypAction.class);

	public Object execute(ExecutionEvent event) throws ExecutionException {
		IPath displayPath = DefaultDisplayPreference.DEFAULT_DISPLAY_PATH_NO_RTYP
				.getValue();
