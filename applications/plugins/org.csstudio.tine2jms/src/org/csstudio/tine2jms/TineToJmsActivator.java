 ...
 */
public class TineToJmsActivator implements BundleActivator {
    ...
    public void start(BundleContext context) throws Exception {
	    TineToJmsActivator.plugin = this;
	    TineToJmsActivator.bundleContext = context;
	}
    ...
    public void stop(BundleContext context) throws Exception {
        TineToJmsActivator.plugin = null;
        TineToJmsActivator.bundleContext = null;
	}
}
