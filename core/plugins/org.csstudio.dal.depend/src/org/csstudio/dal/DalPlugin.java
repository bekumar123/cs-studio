...
import org.csstudio.dal.simple.CompatibilityDALBroker;
...
public class DalPlugin extends Plugin implements PropertyFactoryService {
	...
	private CompatibilityDALBroker broker;
	 ...
	 */
	public synchronized CompatibilityDALBroker getSimpleDALBroker() {
		if (broker == null) {
			broker = CompatibilityDALBroker.newInstance(getApplicationContext(),this);
		}
		return broker;
	}
