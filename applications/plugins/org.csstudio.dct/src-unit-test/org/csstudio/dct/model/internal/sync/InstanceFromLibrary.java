...
class InstanceFromLibrary extends Instance implements IInstance {

    public InstanceFromLibrary(@NotNull @NotUnique String name, @NotNull IPrototype prototype, @NotNull @Unique UUID id) {
