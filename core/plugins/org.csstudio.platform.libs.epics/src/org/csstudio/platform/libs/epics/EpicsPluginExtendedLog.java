...
public class EpicsPluginExtendedLog extends Plugin
{
//    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(EpicsPluginExtendedLog.class);

    public static final String ID = "org.csstudio.platform.libs.epics";

    /** Singleton instance */
    private static EpicsPluginExtendedLog plugin;
     ...
     */
    private static void setPlugin(final EpicsPluginExtendedLog the_plugin)
    {
        EpicsPluginExtendedLog.plugin = the_plugin;
    }
    ...
    public static EpicsPluginExtendedLog getDefault()
    {   return plugin;    }
