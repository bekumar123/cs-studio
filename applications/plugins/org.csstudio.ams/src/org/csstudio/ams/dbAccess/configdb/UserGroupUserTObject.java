...
public class UserGroupUserTObject extends TObject
{
    ...
    public String toString() {
	    StringBuffer buffer = new StringBuffer("UserGroupUser {");
	    buffer.append("group=" + userGroupRef + ",");
        buffer.append("user=" + userRef + ",");
        buffer.append("pos=" + pos + ",");
        buffer.append("active=" + isActive + ",");
        buffer.append("activeReason=" + activeReason + ",");
        buffer.append("timeChange=" + getDateAsLong(timeChange) + "}");
