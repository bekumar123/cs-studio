...
public class HelpDocumentationAction extends Action {
    ...
    public HelpDocumentationAction(final ScreenshotWorker w) {
        worker = w;
    ...
    public void run() {
        MessageDialog.openInformation(null,
                                      ScreenshotMessages.getString("ScreenshotPlugin.Screenshot"),
                                      ScreenshotMessages.getString("ScreenshotView.MESSAGE_NOT_IMPLEMENTED"));
    }
}
