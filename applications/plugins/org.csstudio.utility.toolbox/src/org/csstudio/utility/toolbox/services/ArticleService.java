...
public class ArticleService {
    ...
    public List<Article> findContains(BigDecimal articleDatenId) {
        TypedQuery<ArticleInstalled> query = em.createNamedQuery(ArticleInstalled.FIND_INSTALLED_IN,
                ArticleInstalled.class);
    ...
    public ClearedPersistenceContextResponse<Option<ArticleInStore>> findNewestEntryInStore(BigDecimal articleDatenId) {
        ...
        return new ClearedPersistenceContextResponse<Option<ArticleInStore>>(new Some<ArticleInStore>(
                articlesInStrore.get(0)));
    }
