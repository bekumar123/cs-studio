...
public final class XmlToProject {
    ...
    void createPrototype(Element xmlPrototypeElement) {
        ...
        for (Element xmlParameterElement : (List<Element>) xmlPrototypeElement.getChildren("parameter")) {
            ...
            String description = xmlParameterElement.getAttributeValue("description", "");
            prototype.addParameter(new Parameter(name, value, description));
        }
    ...
    void createRecord(Element xmlRecordElement) {
        ...
        UUID parentRecordId = xmlRecordElement.getAttributeValue("parent") != null ? UUID.fromString(xmlRecordElement
                .getAttributeValue("parent")) : null;
        ...
        if (parentRecordId != null) {
            ...
            // .. new record
            record = RecordFactory.createRecord(project, xmlRecordElement.getAttributeValue("type"),
                    xmlRecordElement.getAttributeValue("name"), id);
