...
//	}
	...
	public ValueIterator getRawValues(int key, String name, Timestamp start,
		...
		AapiValueIterator valueIterator = new RawAapiValueIterator(_aapiClient, key, name, start,end);
	...
	public ValueIterator getOptimizedValues(int key, String name,
			...
			throws UnknownChannelException, Exception {
		AapiValueIterator valueIterator = new MinMaxAapiValueIterator(_aapiClient, key, name, start,end, count);
		valueIterator.getData();
		return valueIterator;
	}
}
