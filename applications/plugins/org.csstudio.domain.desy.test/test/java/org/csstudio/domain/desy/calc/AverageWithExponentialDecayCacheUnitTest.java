...
public class AverageWithExponentialDecayCacheUnitTest {
    ...
    public void testDecay0() {
        ...
        Assert.assertNull(cache.readValue());

        cache.accumulate(1.0);
        Assert.assertEquals(1, cache.getNumberOfAccumulations());
        Assert.assertTrue(Double.valueOf(1.0).equals(cache.readValue()));

        cache.accumulate(2.0);
        Assert.assertEquals(2, cache.getNumberOfAccumulations());
        Assert.assertTrue(Double.valueOf(2.0).equals(cache.readValue()));
    ...
    public void test() {
        ...
        Assert.assertEquals(2, cache.getNumberOfAccumulations());
        // 1.0*0.2 + 2.0*0.8 = 1.8
        Assert.assertTrue(Double.valueOf(1.8).equals(cache.readValue()));
        ...
        Assert.assertTrue(Double.valueOf((1.0*0.2 + 2.0*0.8)*0.2 + 3.0*0.8).equals(cache.readValue()));
        ...
        Assert.assertTrue(Double.valueOf(((1.0*0.2 + 2.0*0.8)*0.2 + 3.0*0.8)*0.2 + 1.5*0.8).equals(cache.readValue()));
    }
}
