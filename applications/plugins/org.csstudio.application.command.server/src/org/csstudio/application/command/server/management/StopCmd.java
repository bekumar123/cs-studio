...
public class StopCmd implements IManagementCommand {
    ...
    private static Stoppable object = null;

    public static void staticInject(Stoppable o) {
        object = o;
    }
    ...
    public CommandResult execute(CommandParameters parameters) {
        ...
        if (object != null) {
            ...
            result = CommandResult.createFailureResult(CommandResultPrefix.getErrorPrefix(1)
                                                       + " Application object is not available.");
        }
        return result;
    }
}
