...
public interface FilterCondition {
	 ...
	 */
	public boolean pruefeNachricht(final AlarmMessage nachricht);
	 ...
	 * @return true, gdw. die Regel auf die Nachricht zutrifft.
	 */
	public boolean pruefeNachricht(final AlarmMessage nachricht, final AlarmMessage vergleichsNachricht);
}