...
public final class ProjectToXmlTest {
    ...
    public void setUp() throws Exception {
        ...
        final IRecord r1 = RecordFactory.createRecord(project, "ai", "r1", new UUID(0, 0));
        r1.setArchived("ai", true);
        r1.setArchived("ab", true);
        r1.setRecordArchived(true);
        r1.addField("ai", "1");
        r1.addField("ab", "1");
    ...
    public void testCreateDocument() throws IOException {
        ...
        assertTrue(xml.contains("archived=\"ai,ab\""));
        assertTrue(xml.contains("recordArchived=\"true\""));
    ...
    private static void traverseElement(final IRecord record) {
        if (record.getId().compareTo(new UUID(0, 0)) == 0) {
            assertTrue(record.getRecordArchived());
            assertTrue(record.getArchived("ai"));
            assertTrue(record.getArchived("ab"));
