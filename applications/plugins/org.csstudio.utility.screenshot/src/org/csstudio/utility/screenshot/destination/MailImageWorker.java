...
public class MailImageWorker implements IImageWorker {
     ...
     * {@inheritDoc}
     */
    public void processImage(final Shell parentShell, final Image image) {
        ...
        if(value == Window.OK && dialog.getMailEntry() != null) {
            ...
            try {
                ...
                final MimeBodyPart bild = new MimeBodyPart();
                ...
                final DataSource source = new FileDataSource(workspaceLocation + imageFilename);
     ...
     * @return
     */
    public BufferedImage convertToBufferedImage(final ImageData data) {
