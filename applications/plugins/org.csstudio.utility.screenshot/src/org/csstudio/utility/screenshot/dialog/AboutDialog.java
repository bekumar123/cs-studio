...
public class AboutDialog extends Dialog implements ActionListener {
    ...
    public AboutDialog(final ApplicationWindow c) {
        this(c.getShell());
        _window = c;
    }

    public AboutDialog(final Shell s) {
        super(s);
    }
    ...
    protected Control createContents(final Composite parent) {
        ...
        */
        ...
        Rectangle rect = new Rectangle(45, 24, 115, 16);
    ...
    protected void initializeBounds() {
        final Point point = GraphicsEnvironment.getLocalGraphicsEnvironment().getCenterPoint();
