package org.csstudio.dal2.simulator.service.data;

import java.util.Random;

import org.csstudio.dal2.simulator.service.ValueProvider;
...
public class RandomLongGenerator implements ValueProvider<Long>{
	 ...
	 */
	public Long get() {
		return (long)(min + (double)(max - min) * random.nextDouble());
	}
