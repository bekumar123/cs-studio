...
public final class OutlinePage extends ContentOutlinePage implements CommandStackListener {
    ...
    private void initDragAndDrop(final TreeViewer viewer) {
        ...
        viewer.addDragSupport(DND.DROP_MOVE | DND.DROP_COPY, new Transfer[] { TextTransfer.getInstance() },
        ...
        viewer.addDropSupport(DND.DROP_MOVE | DND.DROP_COPY, new Transfer[] { TextTransfer.getInstance() },
    ...
    public void selectionChanged(final SelectionChangedEvent event) {
        ...
        if (sel != null && sel.getFirstElement() != null) {
            // FIXME: Mach Probleme beim DnD - vielleicht l�sst sich auf das
