...
public class LogbookSenderDialog extends Dialog implements SelectionListener {
    ...
    private final LogbookEntryStorage storage;
    ...
    public LogbookSenderDialog(final Shell shell) {
	...
	protected Control createDialogArea(final Composite parent) {
        ...
        {
            @Override
            public void newSelection(final String keyword)
            {
                setKeyword(keyword);
            }
        };
    ...
    public String createIdentifyer(final String logbook)
    {
        final SimpleDateFormat    dateFormat  = new SimpleDateFormat(":yyMMdd-HH:mm:ss");
        String              id          = null;
    ...
    private void initDateAndTimeFields(final boolean newDate) {
    ...
    {
        final String line = this.textKeywordlist.getText().trim();
    ...
    public void widgetSelected(final SelectionEvent event) {
        if(event.widget instanceof Button) {
            ...
            final Combo source = (Combo) event.widget;
            final String name = source.getItem(source.getSelectionIndex());
