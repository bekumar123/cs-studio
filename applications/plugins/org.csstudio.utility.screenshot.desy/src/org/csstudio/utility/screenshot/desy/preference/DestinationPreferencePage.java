...
public class DestinationPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage
{
    ...
    public void createFieldEditors() {
        ...
        final Composite mailAddress = createGroup(parent, "DestinationPreferencePage.GROUP_MAIL_ADDRESS");
        ...
        final Composite mailServer = createGroup(parent, "DestinationPreferencePage.GROUP_MAIL_SERVER");
        ...
        final Composite logbookNames = createGroup(parent, "DestinationPreferencePage.GROUP_LOGBOOKS");
        ...
        final Composite groupNames = createGroup(parent, "DestinationPreferencePage.GROUP_GROUPNAMES");
    ...
    private Composite createGroup(final Composite composite, final String label) {
