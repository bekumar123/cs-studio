...
public final class AliasResolutionUtil {
     ...
     * hierarchical parents (classical inheritance) and from containers.
     * 
     * @param container
     *            the container
    ...
    public static Map<String, String> getFinalAliases(IContainer container) {
        ...
        while (!parentStack.isEmpty()) {
            IContainer top = parentStack.pop();
            Map<String, String> values = top.getParameterValues();
            for (Entry<String, String> entry : values.entrySet()) {
                if ((!result.containsKey(entry.getKey()) || ((entry.getValue() != null) && (!entry.getValue().isEmpty())))) {
    ...
    public static Map<String, String> getFinalAliases2(IContainer container) {
        Map<String, String> result = new HashMap<String, String>();
