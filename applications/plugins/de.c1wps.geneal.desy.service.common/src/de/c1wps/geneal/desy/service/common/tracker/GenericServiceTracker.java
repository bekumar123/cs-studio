...
import de.c1wps.geneal.desy.service.common.tracker.internal.GenericActivator;
...
public class GenericServiceTracker<S> extends ServiceTracker {
	...
	public GenericServiceTracker(Class<S> clazz) {
		super(GenericActivator.getBundleContext(), clazz.getName(), null);
		this.clazz = clazz;
		this.serviceListener = Collections.synchronizedList(new ArrayList<IGenericServiceListener<S>>());
	}
