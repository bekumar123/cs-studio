...
public class AddRemoveListFieldEditor extends FieldEditor {
	...
	public AddRemoveListFieldEditor(final String name, final String labelText, final Composite parent)
    {
	    super(name, labelText, parent);
	}

	public AddRemoveListFieldEditor(final String name, final String labelText, final String addButtonText, final String removeButtonText, final Composite parent)
    {
        super(name, labelText, parent);
