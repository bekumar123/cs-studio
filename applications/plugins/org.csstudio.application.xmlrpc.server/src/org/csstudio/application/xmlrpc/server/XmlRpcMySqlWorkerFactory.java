 ...
 * @since 04.01.2013
 */
public class XmlRpcMySqlWorkerFactory extends XmlRpcWorkerFactory {
    
    /**
     * @param pController
     */
    public XmlRpcMySqlWorkerFactory(XmlRpcServer pServer) {
        super(pServer);
    }
    ...
    protected XmlRpcWorker newWorker() {
        return new XmlRpcMySqlWorker(this);
    }
    
    @Override
    public synchronized void releaseWorker(XmlRpcWorker pWorker) {
        super.releaseWorker(pWorker);
    }
}
