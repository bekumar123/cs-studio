...
public class ArchiveVNumberArray extends ArchiveVDisplayType implements VNumberArray
{
    ...
    public ArchiveVNumberArray(final Timestamp timestamp,
            final AlarmSeverity severity, final String status,
            final Display display,String quality,final double... data)
    {
        this(timestamp, severity, status, display,quality, new ArrayDouble(data));
	...
	public ArchiveVNumberArray(final Timestamp timestamp,
            final AlarmSeverity severity, final String status,
            final Display display,String quality, final long... data)
    {
        this(timestamp, severity, status, display,quality,new ArrayLong(data));
    }
	   /** Initialize from longs
     *  @param timestamp
     *  @param severity
    ...
    public ArchiveVNumberArray(final Timestamp timestamp,
            final AlarmSeverity severity, final String status,
            final Display display,String quality, final int... data)
    {
        this(timestamp, severity, status, display, quality,new ArrayInt(data));
    }
    /** Initialize from {@link ListNumber}
     *  @param timestamp
     *  @param severity
	...
	public ArchiveVNumberArray(final Timestamp timestamp,
			final AlarmSeverity severity, final String status,
			final Display display,String quality, final ListNumber data)
	{
		super(timestamp, severity, status, display,quality);
		this.data = data;
	}
