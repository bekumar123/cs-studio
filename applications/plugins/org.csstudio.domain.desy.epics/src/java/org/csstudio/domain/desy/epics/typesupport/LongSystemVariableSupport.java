...
final class LongSystemVariableSupport extends EpicsSystemVariableSupport<Long> {
	...
	protected VType convertEpicsSystemVariableToVType(
			final EpicsSystemVariable<Long> sysVar) throws TypeSupportException {
	...
	@Override
	@Nonnull
	protected VType convertCollectionToVType(final Collection<Long> data,
		 ...
		 final Collection<Integer> longs =
		            Collections2.transform(data,
		                ...
		                @Override
		                @Nonnull
		                public Integer apply(@Nonnull final Long from) {
