...
public class ScreenshotPlugin extends AbstractUIPlugin // implements IStartup
{
    ...
    public static String getInstalledFilePath(final String filepath) {
        String path = null;

        final URL pluginURL = getDefault().getBundle().getEntry(filepath);
    ...
    */
    ...
    public void setMailEntry(final MailEntry me) {
        mailEntry = me;
    }
